...
// const [isSubmit, setIsSubmit] = useState(false);
  ...
  componentDidMount(props) {
    ...
    validate = (values) => {
      console.log("inside validate"+this.state.formValues.username);
    const errors = {}
    ...
    this.setState ( {formValues :  { [e.target.name]: [e.target.value] }});

    // setFormValues({ ...formValues, [name]: value });

    //  this.setState ({FormValues : ({ ...this.formValues ,  [this.name]: this.value })});

    //  this.setState ({FormValues : ({ [this.state.name]: this.state.value })});
  ...
  // this.setState ={error:  "Username is required"};
    ...
    e.preventDefault();
    // this.setFormErrors;
    this.setState ( {setFormErrors :(this.validate(this.state.formValues)) });
